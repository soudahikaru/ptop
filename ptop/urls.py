...
urlpatterns = [
    ...
    path('event_approve/<int:pk_>/', views.event_approve, name='event_approve'),
    ...
    path('operation_detail/<int:pk>/', views.OperationDetailView.as_view(), name='operation_detail'),
    path('change_operation/', views.change_operation, name='change_operation'),
    path('change_operation_generalized/', views.change_operation_generalized, name='change_operation_generalized'),
    path('change_operation_execute/', views.change_operation_execute, name='change_operation_execute'),
    path('operation_result_update/<int:pk>/', views.OperationResultUpdateView.as_view(), name='operation_result_update'),
    path('operation_result_create/', views.OperationResultCreateView.as_view(), name='operation_result_create'),
